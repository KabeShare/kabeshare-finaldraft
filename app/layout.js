...
const customJaLocalization = {
  ...
  errors: {
      ...
      messages: {
          ...
          "form_username_invalid_character": "ユーザー名には英数字とアンダースコア（_）のみ使用できます。",
          "form_password_pwned": "このパスワードは漏洩したことがあります。安全なパスワードを使用してください。",
          "form_identifier_not_found": "識別子が見つかりません。",
          "form_password_incorrect": "パスワードが正しくありません。",
          "user_not_found": "ユーザーが見つかりません。",
          "generic_network": "ネットワークエラーが発生しました。もう一度お試しください。",
